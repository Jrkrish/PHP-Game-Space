...
<h1 class="text-center text-white pt-5">About <b class="text-warning">Us</b></h1><br>
	...
	<center>
	<p style="color:white">
    Drift is your go-to platform for all gaming needs, offering a wide range of games, consoles, and accessories at unbeatable prices. Since 2020, we've welcomed over a million gamers to our site.
		<br><br><br>
	</p>
	</center>
	<hr class="bg-white" style="margin-bottom:70px;">
