          ...
          <div class="row gutters-y">
              ...
              <div class="col-6 col-lg-2">
                ...
                <div class="nav flex-column">
                  <a class="nav-link text-white" href="store-game.php">Games</a>
                  <a class="nav-link text-white" href="store-console.php">Console</a>
                  <a class="nav-link text-white" href="store-accessories.php">Accessories</a>
                </div>
              </div>
              ...
              <div class="col-6 col-lg-2">
                ...
                <div class="nav flex-column">
                  <a class="nav-link text-white" href="about.php">Our Team</a>
                  <a class="nav-link text-white" href="news.php">News</a>
                  <a class="nav-link text-white" href="news.php">Team</a>
				  <a class="nav-link text-white" href="news.php">Blog</a>
                </div>
              </div>
              ...
              <div class="col-6 col-lg-2">
                ...
                <div class="nav flex-column">
                  <a class="nav-link text-white" href="about.php">John Weshley</a>
                </div>
              </div>
